...
public class ${pluginClassName}ProfileDialog implements IProfileDialog {
	
	private static final Logger logger = LoggerFactory.getLogger(${pluginClassName}ProfileDialog.class);
