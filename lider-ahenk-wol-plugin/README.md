...
Wol plugin for [Lider Ahenk project](http://www.liderahenk.org.tr) which can be used to enable Wake-On-LAN on Ahenk-installed machine and wake this machine by sending 'magic' packet.
