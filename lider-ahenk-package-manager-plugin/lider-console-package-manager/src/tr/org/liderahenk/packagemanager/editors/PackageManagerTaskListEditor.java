package tr.org.liderahenk.packagemanager.editors;
...
public class PackageManagerTaskListEditor extends EditorPart {

	private static final Logger logger = LoggerFactory.getLogger(PackageManagerTaskListEditor.class);
		...
		tableViewer.addDoubleClickListener(new IDoubleClickListener() {
			...
			public void doubleClick(DoubleClickEvent event) {
				try {
					...
					ExecutedTaskDialog dialog = new ExecutedTaskDialog(parent.getShell(), selectedTask, command);
					dialog.create();
					dialog.open();
				} catch (Exception e1) {
		...
		taskColumn.setLabelProvider(new ColumnLabelProvider() {
			...
			public String getText(Object element) {
				if (element instanceof ExecutedTask) {
					return Messages.getString("PACKAGE_MANAER_LABEL") + " "
	...
	private void populateTable() {
		try {
			...
			tasks = TaskRestUtils.listExecutedTasks(PackageManagerConstants.PLUGIN_NAME, false, false, null, null, null,
