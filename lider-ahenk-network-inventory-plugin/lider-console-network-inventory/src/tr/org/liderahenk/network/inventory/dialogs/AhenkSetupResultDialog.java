...
import tr.org.liderahenk.network.inventory.model.AhenkSetupResultDetail;

/**
 * A dialog that shows the result of an Ahenk installation command.
 * 
 * @author <a href="mailto:caner.feyzullahoglu@agem.com.tr">Caner
 *         Feyzullahoğlu</a>
 */
public class AhenkSetupResultDialog extends Dialog {

	private TableViewer tblViewer;

	private List<AhenkSetupResultDetail> resultList;

	public AhenkSetupResultDialog(Shell parentShell, List<AhenkSetupResultDetail> resultList) {
		super(parentShell);
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText(Messages.getString("AHENK_INSTALLATION_RESULTS"));
	}
	...
	private void createTableColumns() {
		...
		ipCol.setLabelProvider(new ColumnLabelProvider() {
			...
			public String getText(Object element) {
				String ip = ((AhenkSetupResultDetail) element).getIp();
		...
		successCol.setLabelProvider(new ColumnLabelProvider() {
			...
			public String getText(Object element) {
				String result;
				if (((AhenkSetupResultDetail) element).isSuccess()) {
		...
		messageCol.setLabelProvider(new ColumnLabelProvider() {
			@Override
			public String getText(Object element) {
				String errorMessage = ((AhenkSetupResultDetail) element).getMessage();
