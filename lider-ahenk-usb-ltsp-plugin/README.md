...
1. Create a soft link for _ahenk-usb-ltsp/usb-ltsp_ directory via `sudo ln -s lider-ahenk-usb-ltsp-plugin/ahenk-usb-ltsp/usb-ltsp/ /usr/share/ahenk/plugins`
