...
public class StartAutoEditingSupport extends EditingSupport {

	private final TableViewer viewer;
	private final CellEditor editor;

	public StartAutoEditingSupport(TableViewer viewer) {
		super(viewer);
		this.viewer = viewer;
	...
	protected Object getValue(Object element) {
		...
		if (element instanceof ServiceListItem) {
			return ((ServiceListItem) element).getDesiredStartAuto();
		}
	...
	protected void setValue(Object element, Object value) {
		if (element instanceof ServiceListItem) {
			((ServiceListItem) element).setDesiredStartAuto((DesiredStatus) value);
