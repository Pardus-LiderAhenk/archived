...
public class RestoreServerConfDialog extends DefaultLiderDialog {

	private static final Logger logger = LoggerFactory.getLogger(RestoreServerConfDialog.class);
	...
	public RestoreServerConfDialog(Shell parentShell) {
		super(parentShell);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		spnDestPort.setSelection(RestoreConstants.DEFAULT_PORT_INT);
		...
		txtDestPath.setText(RestoreConstants.DEFAULT_DEST_PATH);
...
//		TaskRequest task = new TaskRequest(null, null, RestoreConstants.PLUGIN_NAME, RestoreConstants.PLUGIN_VERSION,
