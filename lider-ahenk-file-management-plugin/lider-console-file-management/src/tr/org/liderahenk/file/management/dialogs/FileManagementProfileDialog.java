...
public class FileManagementProfileDialog implements IProfileDialog {
	
	private static final Logger logger = LoggerFactory.getLogger(FileManagementProfileDialog.class);
