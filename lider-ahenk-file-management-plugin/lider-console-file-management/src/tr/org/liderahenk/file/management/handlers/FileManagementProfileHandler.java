...
import tr.org.liderahenk.file.management.dialogs.FileManagementProfileDialog;
...
/**
 * Profile definition handler for file-management plugin.
 *
 */
public class FileManagementProfileHandler extends AbstractHandler {

	private Logger logger = LoggerFactory.getLogger(FileManagementProfileHandler.class);
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        try {
			...
			page.openEditor(new ProfileEditorInput(Messages.getString("FileManagement"), FileManagementConstants.PLUGIN_NAME, 
					FileManagementConstants.PLUGIN_VERSION, new FileManagementProfileDialog()), 
