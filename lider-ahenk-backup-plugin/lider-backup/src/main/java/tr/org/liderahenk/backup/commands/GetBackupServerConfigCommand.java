...
public class GetBackupServerConfigCommand implements ICommand {

	private Logger logger = LoggerFactory.getLogger(GetBackupServerConfigCommand.class);
	...
	public String getCommandId() {
		return "GET_BACKUP_SERVER_CONFIG";
	}
