...
public class UpdateAttributeCommand implements ICommand {

	private Logger logger = LoggerFactory.getLogger(UpdateAttributeCommand.class);
	...
	public ICommandResult execute(ICommandContext context) {
		...
		ldapService.updateEntry(dn, attribute, value);
