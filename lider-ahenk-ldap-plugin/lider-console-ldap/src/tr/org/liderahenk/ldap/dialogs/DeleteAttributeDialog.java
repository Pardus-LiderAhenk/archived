...
import tr.org.liderahenk.liderconsole.core.model.LiderLdapEntry.AttributeWrapper;
 ...
 * 
 */
public class DeleteAttributeDialog extends DefaultLiderTitleAreaDialog {

	private static final Logger logger = LoggerFactory.getLogger(DeleteAttributeDialog.class);
	...
	private Combo combo;
	private LiderLdapEntry.AttributeWrapper selectedAttribute;
	
	/**
	 * @wbp.parser.constructor
	 */
	public DeleteAttributeDialog(Shell parentShell, String dn) {
		super(parentShell);
		this.dn=dn;
	}
	public DeleteAttributeDialog(Shell parentShell, String dn, Map<String,Object> params) {
		super(parentShell);
		this.dn=dn;
		selectedAttribute= (AttributeWrapper) params.get("selectedAttribute");
	}
	
	@Override
	public void create() {
		super.create();
		setTitle(Messages.getString("delete_attribute"));
        setMessage("Seçili Öznitelik Silinecektir. Emin misiniz?", IMessageProvider.INFORMATION);
	}
	...
	public Control createDialogArea(Composite parent) {
		...
		combo.setItems(new String[] {"sudoRole", "sudoHost", "description", "dn", "gIdNumber", "sn", "mail"});
		...
		combo.setText(selectedAttribute.getAttName());
		textDesc.setText(selectedAttribute.getAttValue());
