 ...
 * 
 */
public class UpdateAttributeDialog extends DefaultLiderTitleAreaDialog {

	
	private static final Logger logger = LoggerFactory.getLogger(UpdateAttributeDialog.class);
	 ...
	 */
	public UpdateAttributeDialog(Shell parentShell, String dn) {
		super(parentShell);
		this.dn=dn;
	}
	public UpdateAttributeDialog(Shell parentShell, String dn, Map<String,Object> params) {
		super(parentShell);
		this.dn=dn;
	...
	public void create() {
		super.create();
		setTitle(Messages.getString("update_attribute"));
