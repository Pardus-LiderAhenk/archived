...
import tr.org.liderahenk.ldap.dialogs.LdapProfileDialog;
...
/**
 * Profile definition handler for ldap plugin.
 *
 */
public class LdapProfileHandler extends AbstractHandler {

	private Logger logger = LoggerFactory.getLogger(LdapProfileHandler.class);
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        try {
			...
			page.openEditor(new ProfileEditorInput(Messages.getString("Ldap"), LdapConstants.PLUGIN_NAME, 
					LdapConstants.PLUGIN_VERSION, new LdapProfileDialog()), 
