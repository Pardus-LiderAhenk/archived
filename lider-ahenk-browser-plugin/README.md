...
Browser plugin for [Lider Ahenk project](http://www.liderahenk.org.tr) which can be used to manage Firefox web browser.
...
1. Clone the plugin project by running `git clone https://github.com/Pardus-LiderAhenk/lider-ahenk-browser-plugin.git`.
2. Open Eclipse and import the plugin project into Eclipse as 'Existing Maven Projects'.
3. Navigate to _lider-ahenk-browser-plugin/scripts_ directory and run `build-plugin.sh`.
