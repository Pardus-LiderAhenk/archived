...
public class XMessageCommand implements ICommand {

	private Logger logger = LoggerFactory.getLogger(XMessageCommand.class);
	...
	public ICommandResult execute(ICommandContext context) {
		...
		logger.debug("Executing Xmessage Command method working.");
