...
1. Create a soft link for _ahenk-network-manager/network-manager_ directory via `sudo ln -s lider-ahenk-network-manager-plugin/ahenk-network-manager/network-manager/ /usr/share/ahenk/plugins`
